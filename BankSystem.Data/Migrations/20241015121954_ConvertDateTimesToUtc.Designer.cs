...
namespace BankSystem.Data.Migrations
{
    ...
    [Migration("20241015121954_ConvertDateTimesToUtc")]
    partial class ConvertDateTimesToUtc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankSystem.Domain.Models.PositionStorage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BankSystem.Domain.Models.Employee", b =>
                {
                    b.HasOne("BankSystem.Domain.Models.PositionStorage", "PositionStorage")
                        .WithMany("Employees")
                        .HasForeignKey("PositionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("PositionStorage");
                });
